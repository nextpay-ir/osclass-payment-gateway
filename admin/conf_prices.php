...
if(Params::getParam('plugin_action')=='add_category') {
    if(Params::getParam('catId')!='') {
        ModelNextPayPayment::newInstance()->insertPrice(
    ...
    if(Params::getParam('catId')!='') {
        ModelNextPayPayment::newInstance()->deletePrices(Params::getParam('catId'));
...
$prices= ModelNextPayPayment::newInstance()->getCategoriesPrices();
                    ...
                    <?php foreach($prices as $price) {
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-controls">
                                <span class="payment-pub" ><?php printf(__('Publish cost: %s %s', 'payment'), $price['f_publish_cost'], osc_get_preference('currency', 'payment')); ?></span>
                                <span class="payment-prm" ><?php printf(__('Premium cost: %s %s', 'payment'), $price['f_premium_cost'], osc_get_preference('currency', 'payment')); ?></span>
...
/*
    ...
    $mp = ModelNextPayPayment::newInstance();
